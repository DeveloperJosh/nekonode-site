    ...
    <footer className="bg-gray-800 text-white py-8">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between">
        <div className="flex flex-col md:flex-row items-center mb-4 md:mb-0">
          <Link href="https://discord.gg/88ArBFRcY8" className="text-lg font-semibold">Join Our Discord</Link>
        </div>
        <div className="flex flex-col md:flex-row items-center">
          <nav className="flex flex-col md:flex-row md:items-center mb-4 md:mb-0">
            <Link href="/about" className="text-gray-300 hover:text-white px-3 py-2">About Us</Link>
            <Link href="https://discord.gg/88ArBFRcY8" className="text-gray-300 hover:text-white px-3 py-2">Discord</Link>
            <Link href="/privacy" className="text-gray-300 hover:text-white px-3 py-2">Privacy Policy</Link>
            <Link href="/terms" className="text-gray-300 hover:text-white px-3 py-2">Terms of Service</Link>
          </nav>
          <div className="flex justify-center md:justify-start space-x-4">
            <Link href="https://www.facebook.com" className="text-gray-300 hover:text-white">
            ...
            <Link href="https://www.instagram.com" className="text-gray-300 hover:text-white">
              <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
